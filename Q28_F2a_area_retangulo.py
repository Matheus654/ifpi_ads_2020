def main():
    ...
    x1_utilizavel = valor_x1_positivo(x1)
    y1_utilizavel = valor_y1_positivo(y1)
    x2_utilizavel = valor_x2_positivo(x2)
    y2_utilizavel = valor_y2_positivo(y2)

    area_retangulo = ((x1_utilizavel + x2_utilizavel) * (y1_utilizavel + y2_utilizavel))
